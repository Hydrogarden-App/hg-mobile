...
//   }) : super(const DeviceInfoState.loading()) {
//     on<DeviceInfoDataRequested>((event, emit) async {
//       emit(DeviceInfoState.loading());

//       final device = await localDeviceInfoRepository.getDeviceInfo(event.id);
//       emit(DeviceInfoState.loaded(device));
//       try {
//         final remoteDevice = await remoteDeviceInfoRepository.getDeviceInfo(
//           event.id,
//         );
//         emit(DeviceInfoState.loaded(remoteDevice));
//         connectionBloc.add(
...
//     on<DeviceInfoTurnOffRequested>((event, emit) async {
//       try {
//         final updatedDevice = await deviceStateRepository.disableDevice(
//           event.id,
//         );
//         emit(DeviceInfoState.loaded(updatedDevice));
//       } catch (_) {
//         emit(DeviceInfoState.error("Nie udało się zaktualizować informacji"));
//         connectionBloc.add(
//           ConnectionServerStatusUpdated(ServerStatus.disconnected),
//         );
//       }
...
//     on<DeviceInfoTurnOnRequested>((event, emit) async {
//       try {
//         final updatedDevice = await deviceStateRepository.enableDevice(
//           event.id,
//         );
//         emit(DeviceInfoState.loaded(updatedDevice));
//       } catch (_) {
