...
class DeviceSyncManager {
  ...
  final StreamController<DeviceSyncState> _controller =
  ...
  Stream<DeviceSyncState> watchDevices() => _controller.stream;

  Stream<DeviceSyncState> watchDevice(int deviceId) {
